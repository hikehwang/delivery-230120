...
public class PolicyHandler{
    ...
    public void wheneverOrderPlaced_OrderInfoTransfered(@Payload OrderPlaced orderPlaced){

        OrderPlaced event = orderPlaced;
        System.out.println("\n\n##### listener OrderInfoTransfered : " + orderPlaced + "\n\n");


        

        // Sample Logic //
        StoreOrder.orderInfoTransfered(event);
